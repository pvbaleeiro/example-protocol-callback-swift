//
//  DelegateSelectionViewController.swift
//  example-protocol
//
...
//-------------------------------------------------------------------------------------------------------------
protocol DelegateSelectionViewControllerDelegate {
    func selecionouVeiculo(veiculo: Veiculo)
}


class DelegateSelectionViewController: BaseViewController {
    ...
    var selectionDelegate: DelegateSelectionViewControllerDelegate?
    //Control, aux
...
//-------------------------------------------------------------------------------------------------------------
extension DelegateSelectionViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectionDelegate?.selecionouVeiculo(veiculo: veiculo)
...
//-------------------------------------------------------------------------------------------------------------
extension DelegateSelectionViewController: UITableViewDataSource {
